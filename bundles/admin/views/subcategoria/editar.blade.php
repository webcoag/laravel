			...
			<form id="edit-profile" class="form-horizontal" action="" method="POST">
				<fieldset>
							...
							<select id="categoria_id" name="categoria_id">
								...
								<?php 
									foreach ($categorias as $categoria) {
										?>
											<option value="<?php echo $categoria->id ?>" <?php ($subcategoria->categoria_id == $categoria->id) ? print "selected='selected'" : false ; ?>><?php echo $categoria->nome; ?></option>
										<?php
									}
								?>
							</select>
					...
					<div class="control-group <?php ($errors->has('nome')) ? print 'error' : false ; ?>">											
						...
						<div class="controls">
							<input type="text" class="input-large" id="nome" name="nome" value="<?php echo $subcategoria->nome; ?>">
