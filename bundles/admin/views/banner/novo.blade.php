			...
			<form id="edit-profile" class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
				<fieldset>
					...
					<?php 
						if(isset($cadastro)){
							if($cadastro['sucesso'] == true){
								echo Alert::success('<strong>Banner cadastrado com sucesso</strong>', false);
							} else {
								echo Alert::error('<strong>Atenção:</strong> houve um erro ao cadastrar o banner. Por favor, tente novamente.', false);
							}
						}
					?>
					...
					<div class="control-group <?php ($errors->has('descricao')) ? print 'error' : false ; ?>">											
						...
						<div class="controls">
							<input type="text" class="input-large" id="descricao" name="descricao" value="<?php echo Input::get('descricao'); ?>">
